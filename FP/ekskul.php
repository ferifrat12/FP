...
<html lang="en">
  <head>
    ...
    <title>Halaman Ekstrakulikuler</title>
  </head>
  <body>
    <div>
...
<div class="p-5  mb-1 bg-light rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Extrakurikuler</h1>
        <p class="col-md-8 fs-4">Disini anda bisa melihat Extrakurikuler yang ada di SMA Karasuno</p>
      ...
      <div >
          <img src="admin/assets/EksRenang.png" alt="" width="850px" >
          <br><br>
          <h2> Swimming</h2>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci nam alias hic quod accusamus, et excepturi! Beatae exercitationem sequi nostrum, commodi accusamus sapiente, enim eos delectus adipisci, numquam sed dolores.</p>
